...
function lib:Window(text, preset, closebind)
	...
	function lib:SideNotification(title, description)
		local SideNotificationHold = Instance.new("TextButton")
		local SideNotificationFrame = Instance.new("Frame")
		local SideNotificationTitle = Instance.new("TextLabel")
		local SideNotificationDesc = Instance.new("TextLabel")

		SideNotificationHold.Name = "NotificationHold"
		SideNotificationHold.Parent = Main
		SideNotificationHold.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
		SideNotificationHold.BackgroundTransparency = 1.000
		SideNotificationHold.BorderSizePixel = 0
		SideNotificationHold.Size = UDim2.new(0, 560, 0, 319)
		SideNotificationHold.AutoButtonColor = false
		SideNotificationHold.Font = Enum.Font.SourceSans
		SideNotificationHold.Text = ""
		SideNotificationHold.TextColor3 = Color3.fromRGB(0, 0, 0)
		SideNotificationHold.TextSize = 14.000
		...
		SideNotificationFrame.Parent = SideNotificationHold
		SideNotificationFrame.AnchorPoint = Vector2.new(0.5, 0.5)
		SideNotificationFrame.BackgroundColor3 = Color3.fromRGB(30, 30, 30)
		SideNotificationFrame.BorderSizePixel = 0
		SideNotificationFrame.ClipsDescendants = true
		SideNotificationFrame.Position = UDim2.new(5, 5, 5, 0)

		SideNotificationFrame:TweenSize(
		...
		SideNotificationTitle.Name = "NotificationTitle"
		SideNotificationTitle.Parent = SideNotificationFrame
		SideNotificationTitle.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
		SideNotificationTitle.BackgroundTransparency = 1.000
		SideNotificationTitle.Position = UDim2.new(0.0670731738, 0, 0.0829015523, 0)
		SideNotificationTitle.Size = UDim2.new(0, 143, 0, 26)
		SideNotificationTitle.Font = Enum.Font.Gotham
		SideNotificationTitle.Text = title
		SideNotificationTitle.TextColor3 = Color3.fromRGB(255, 255, 255)
		SideNotificationTitle.TextSize = 18.000
		SideNotificationTitle.TextXAlignment = Enum.TextXAlignment.Left

		SideNotificationDesc.Name = "NotificationDesc"
		SideNotificationDesc.Parent = SideNotificationFrame
		SideNotificationDesc.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
		SideNotificationDesc.BackgroundTransparency = 1.000
		SideNotificationDesc.Position = UDim2.new(0.0670000017, 0, 0.218999997, 0)
		SideNotificationDesc.Size = UDim2.new(0, 143, 0, 91)
		SideNotificationDesc.Font = Enum.Font.Gotham
		SideNotificationDesc.Text = description
		SideNotificationDesc.TextColor3 = Color3.fromRGB(255, 255, 255)
		SideNotificationDesc.TextSize = 15.000
		SideNotificationDesc.TextWrapped = true
		SideNotificationDesc.TextXAlignment = Enum.TextXAlignment.Left
		SideNotificationDesc.TextYAlignment = Enum.TextYAlignment.Top
